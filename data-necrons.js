/* ============================================================
   ...
   Les tables sont enfermées dans une fonction et remises au registre
   de data.js : elles ne sont plus des globales, c'est l'adaptateur qui
   les met en service quand cette faction devient la faction active.
   ============================================================ */
(function(){
"use strict";
...
const STRAT_SIMU = [
 ...
 /* Ce strategeme fait DEUX choses, et la seconde depend de la table :
    ...
    il suffisait de brancher l'une sur l'autre. Deux boutons pour un
    seul strategeme -- la solution d'avant -- laissaient croire a deux
    depenses de PC. */
...
enregistreFaction({
  ...
  tables : {
    ...
    /* les trois tables que seuls les Nécrons ont : les Entraves
       Nécrodermiques du Panthéon de Malheur, les optimisations qu'il
       retire, et le choix à cinq branches du Conclave de Crypteks */
    ENTRAVES, ENH_OTEES, SITU_CHOIX
  }
});
})();
