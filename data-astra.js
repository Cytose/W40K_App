/* ============================================================
   ...
   STRATS porte 68 stratagèmes : ceux des détachements que le
...
const DETACHMENTS = [
  ["Abhuman Auxiliaries",1,"Abhuman","Absolutist Principles","▪ Friendly BULLGRYN SQUAD/OGRYN SQUAD/RATLINGS units have ABHUMAN. ▪ Friendly COMMISSAR models can: ▪ Issue the Take Aim! Order. ▪ Issue 1 Order to a friendly ABHUMAN unit. This detachment has the ABHUMAN tag and cannot be taken with another ABHUMAN detachment.","",0,"","Take and Hold"],
  ["Armoured Infantry",2,"","Squadron Command","Add Squadron to the list of units each Officer unit from your army can issue Orders to. Add the Order below to those listed in the Voice of Command ability. ON MY SIGNAL The most effective commanders know how and when to make use of their armoured fighting vehicles’ speed. This Order can only be issued to Armoured Skirmisher units (see below). Each time an enemy unit ends a Normal or Advance move within 8\" of this unit, this unit can make a Normal move of up to D6\". Each unit can only move in this way once per turn. KEYWORDS Astra Militarum Squadron units from your army have the ARMOURED SKIRMISHER keyword (excluding Artillery units and units containing one or more models with a Wounds characteristic of 13 or higher).","",0,"","Take and Hold"],
  ["Bridgehead Strike",1,"","Fire Zone Purge","▪ If a friendly MILITARUM TEMPESTUS OFFICER model is your WARLORD, friendly TEMPESTUS SCIONS units have: ▪ BATTLELINE. ▪ +1 OC. ▪ When a friendly MILITARUM TEMPESTUS unit is selected to shoot, if that unit was set up this turn, that unit’s ranged attacks have +1 to hit rolls.","",0,"","Priority Assets"],
  ["Combined Arms",2,"","Born Soldiers","Each time a model in a Regiment unit from your army makes a ranged attack that targets a visible unit (excluding MONSTERS and VEHICLES), that attack has the [LETHAL HITS] ability. Each time a model in a Squadron unit from your army makes a ranged attack that targets a visible MONSTER or VEHICLE unit, that attack has the [LETHAL HITS] ability.","",0,"","Take and Hold"],
  ["Designation Force",1,"Recon","Designated Targets","Friendly SCOUT SENTINEL/ASTRA MILITARUM INFANTRY SMOKE units have the following ability: Signal Flares: In your Shooting phase, this unit can select one visible enemy unit within 12\". That enemy unit is designated: ▪ While a unit is designated, that unit has +3\" detection range. This detachment has the RECON tag and cannot be taken with another RECON detachment.","",0,"","Reconnaissance"],
  ["Grizzled Company",3,"Abhuman","Ruthless Discipline","Add 1 to the number of Orders each Astra Militarum Officer model from your army can issue, as stated on their datasheet. While an ASTRA MILITARUM unit from your army is affected by an Order, each time a model in that unit makes an attack, re-roll a Hit roll of 1.","",0,"","Priority Assets"],
  ["Hammer Of The Emperor",2,"","Iron Tread","Each time a Squadron unit from your army Advances, do not make an Advance roll for it; until the end of the phase, add 6\" to the Move characteristic of models in that unit, and when making that Advance move, that unit can move within Engagement Range of enemy models but cannot end that move within Engagement Range of enemy models.","",0,"","Purge the Foe"],
  ["Mechanised Assault",2,"","Armoured Fist","Each time an ASTRA MILITARUM model from your army makes a ranged attack in a turn in which it disembarked from a Transport, add 1 to the Wound roll.","",0,"","Reconnaissance"],
  ["Recon Element",3,"Recon","Masters of Camouflage","Astra Militarum Walker and Regiment units from your army have the Benefit of Cover. While such a unit has the Benefit of Cover for any other reason, improve the Save characteristic of that unit by 1 (to a maximum of 3+).","",0,"","Reconnaissance"],
  ["Siege Regiment",2,"","Artillery Support","At the start of the battle round, select one of the following types of artillery support. ▪ Creeping Barrage: Roll one D6 for each enemy unit that is more than 12\" from every model from your army that is on the battlefield: On a 5+, until the end of the battle round, that unit is shaken. While a unit is shaken, subtract 2\" from its Move characteristic and subtract 2 from Charge rolls made for it. The maximum number of units that can be shaken by this rule in each battle round depends on the battle size, as shown below. ▪ Incendiary Bombardment: Select a number of enemy units more than 12\" from every model from your army that is on the battlefield. Until the end of the battle round, those enemy units are scattered. While a unit is scattered, it cannot have the Benefit of Cover. The maximum number of units you can select in this way depends on the battle size, as shown below. ▪ Smoke Shells: Select a number of units from your army. Until the end of the battle round, those units have the Stealth ability. BATTLE SIZEMAXIMUM NUMBER OF UNITSIncursion2Strike Force3Onslaught4","",0,"","Disruption"],
  ["Steel Hammer",2,"","Ceaseless Cannonade","Each time an Astra Militarum Titanic or Astra Militarum Squadron unit from your army is selected to shoot, models in that unit can target enemy units within Engagement Range of that unit (including with Blast weapons), provided no other friendly units are also within Engagement Range of that enemy unit. When doing so, such models do not suffer the penalty to their Hit rolls for being within Engagement Range of one or more enemy units (excluding attacks made with Indirect Fire weapons). KEYWORDS In the Muster Armies step, you can select one or more ASTRA MILITARUM TITANIC units from your army to gain the CHARACTER keyword. Designer’s Note: This means that the selected units can be given Enhancements, and one of them can be selected as your WARLORD.","",0,"","Purge the Foe"]
];

/* ENHANCEMENTS : [nom, coût, détachement, texte, cible] */
const ENHANCEMENTS = [
  ["Exemplar of Duty (Upgrade)",10,"Abhuman Auxiliaries","COMMISSAR model only. This model has Feel No Pain 4+.",null],
  ...
  ["Long-range Scout (Upgrade)",10,"Designation Force","SCOUT SENTINEL unit only. This unit has Infiltrators",null],
  ["Recon Star (Upgrade)",10,"Designation Force","ASTRA MILITARUM INFANTRY PLATOON unit only. In your first Movement phase, this unit can make an ingress move.",null],
...
const STRATS = [
  ["Low Profile","Abhuman Auxiliaries","",1,"Your Shooting phase, when a friendly RATLINGS unit has shot.","That RATLINGS unit.","Those ranged attacks do not prevent your unit from being hidden.",""],
  ["Stirred to Action","Abhuman Auxiliaries","",1,"Your opponent’s Shooting phase, when an enemy unit that targeted a friendly unengaged BULLGRYN SQUAD/OGRYN SQUAD unit has shot.","That BULLGRYN SQUAD/OGRYN SQUAD unit.","Your unit can make a surge move of up to D6\".",""],
  ["Thick-Skulled Obdurance","Abhuman Auxiliaries","",1,"Your opponent’s Shooting phase or the Fight phase, when an enemy unit targets a friendly BULLGRYN SQUAD/OGRYN SQUAD unit that is within range of an objective.","That BULLGRYN SQUAD/OGRYN SQUAD unit.","Attacks that target your unit have -1 AP until that enemy unit has attacked.",""],
  ["Burst of Speed","Armoured Infantry","Ruse Stratégique",1,"End of your Movement phase.","One ASTRA MILITARUM unit from your army that did not Remain Stationary or arrive from Reserves this phase.","Your unit can make a Normal move of up to D6\".",""],
  ["Combined Fire","Armoured Infantry","Tactique de Bataille",1,"Your Shooting phase, just after an Armoured Skirmisher unit from your army has shot.","That ARMOURED SKIRMISHER unit.","Select one enemy unit hit by one or more of those attacks. Until the end of the phase, that enemy unit cannot have the Benefit of Cover, and each time an ARMOURED SKIRMISHER unit from your army makes an attack that targets that unit, improve the Strength characteristic of that attack by 2.",""],
  ["Mobile Firebase","Armoured Infantry","Ruse Stratégique",1,"Your Movement phase, just after an Armoured Skirmisher unit from your army Advances or Falls Back.","That ARMOURED SKIRMISHER unit.","Until the end of the turn, your unit is eligible to shoot in a turn in which it Advanced or Fell Back.",""],
  ["Opening Salvo","Armoured Infantry","Tactique de Bataille",1,"Your Shooting phase.","One ASTRA MILITARUM unit from your army that disembarked from a Transport this turn and has not been selected to shoot this phase.","Until the end of the phase, each time a model in your unit makes an attack, add 1 to the Wound roll.",""],
  ["Order the Advance","Armoured Infantry","Tactique de Bataille",1,"Start of your Movement phase.","One Astra Militarum Officer unit from your army.","Select one or more friendly ASTRA MILITARUM units within 6\" of your unit; until the end of the phase, you can re-roll Advance rolls made for those units.",""],
  ...
  ["Inspired Command","Combined Arms","Fait Épique",1,"Your opponent’s Command phase.","One Astra Militarum Officer unit from your army.","Your OFFICER can issue one Order as if it were your Command phase.",""],
  ["Reinforcements!","Combined Arms","Ruse Stratégique",2,"Any phase.","One Infantry Regiment unit from your army that was just destroyed. You can target that unit with this Stratagem even though it was just destroyed.","Add a new unit to your army identical to your destroyed unit, in Strategic Reserves, at its Starting Strength and with all of its wounds remaining.","This Stratagem cannot be used to return destroyed CHARACTER units to Attached units. You can only use this Stratagem once per battle."],
  ["Stalwart Protector","Combined Arms","Tactique de Bataille",1,"Your opponent’s Shooting phase, just after an enemy unit has selected its targets.","One Astra Militarum Vehicle unit from your army.","Until the end of the phase, each time a ranged attack is allocated to an INFANTRY model from your army, if that model is not fully visible to every model in the attacking unit because of your VEHICLE, that model has the Benefit of Cover against that attack.",""],
  ["Close-Range Detection","Designation Force","",1,"Start of your Shooting phase.","One friendly SCOUT SENTINEL/ASTRA MILITARUM INFANTRY unit.","While a visible enemy unit is within 6\" of your unit, that unit has +3\" detection range.",""],
  ["Sump-Smog Screen","Designation Force","",1,"Start of your opponent’s Shooting phase","One friendly ASTRA MILITARUM INFANTRY SMOKE unit.","When an attack targets either your unit, or a unit that is not fully visible to the attacking model because of one or more models in your unit, the target has the benefit of cover against that attack.",""],
  ["Triggered Alerts","Designation Force","",1,"Your opponent’s Movement phase, when an enemy unit ends a move within 8\" of a friendly unengaged ASTRA MILITARUM INFANTRY unit.","That ASTRA MILITARUM INFANTRY unit.","Your unit can make a normal move of up to D3+3\"",""],
  ["Additional Armour","Grizzled Company","",1,"Your opponent’s Shooting phase, just after an enemy unit has selected its targets.","One ASTRA MILITARUM unit from your army that was selected as the target of one or more of the attacking unit’s attacks.","Until the attacking unit has finished making its attacks, each time an attack targets your unit, worsen the Armour Penetration characteristic of that attack by 1.",""],
  ["Mordian Minute","Grizzled Company","",1,"Your Shooting phase.","One Astra Militarum Infantry unit from your army affected by the First Rank, Fire! Second Rank, Fire! Order.","Until the end of the phase, each time a model in your unit makes an attack, improve the Strength characteristic of that attack by 1.",""],
  ["No Retreat!","Grizzled Company","",1,"Your Command phase.","One ASTRA MILITARUM unit from your army affected by the Duty and Honour! Order.","If your unit is within range of an objective marker you control, that objective marker remains under your control, even if you have no models within range of it, until your opponent controls it at the start or end of a phase.",""],
  ["Purging Fire","Grizzled Company","",1,"Your Shooting phase.","One ASTRA MILITARUM unit from your army affected by an Order that has not been selected to shoot this phase.","If your unit is within range of an objective marker, until the end of the phase, ranged weapons equipped by models in your unit have the [LETHAL HITS] ability.",""],
  ["Snap to It","Grizzled Company","",1,"Start of any phase.","One Astra Militarum Officer unit from your army.","Your unit’s OFFICER model can issue 1 Order as if it were your Command phase.",""],
  ["Veteran Sharpshooters","Grizzled Company","",1,"Your Shooting phase.","One ASTRA MILITARUM unit from your army that has not been selected to shoot this phase.","Until the end of the phase, ranged weapons equipped by models in your unit have the [IGNORES COVER] ability.",""],
  ["Ablative Plating","Hammer Of The Emperor","Équipement",2,"Your opponent’s Shooting phase, just after an enemy unit has selected its targets.","One Astra Militarum Vehicle unit from your army that was selected as the target of one or more of the attacking unit’s attacks.","Until the end of the phase, each time an attack is allocated to your unit, subtract 1 from the Damage characteristic of that attack.",""],
  ["Blazing Advance","Hammer Of The Emperor","Tactique de Bataille",1,"Your Movement phase, just after a Squadron unit from your army Advances.","That SQUADRON unit.","Until the end of the turn, your unit is eligible to shoot in a turn in which it Advanced.",""],
  ["Crash Through","Hammer Of The Emperor","Ruse Stratégique",1,"Your Movement phase or your Charge phase.","One Astra Militarum Vehicle unit from your army that has not been selected to move or charge this phase.","Until the end of the phase, each time your unit makes a Normal, Advance or Charge move, it can move horizontally through terrain features as if they were not there.",""],
  ["Final Hour","Hammer Of The Emperor","Fait Épique",1,"Your Command phase.","One Squadron unit from your army that is Below Half-strength (excluding Officer units).","Until the end of the battle round, ranged weapons equipped by models in your unit (excluding [ONE SHOT] weapons) have the [HAZARDOUS] ability, and each time a model in your unit makes a ranged attack, you can ignore any or all modifiers to that attack’s Ballistic Skill characteristic and to the Hit roll.",""],
  ["Furious Cannonade","Hammer Of The Emperor","Tactique de Bataille",1,"Your Shooting phase.","One Squadron unit from your army that has not been selected to shoot this phase.","Until the end of the phase, each time a model in your unit makes an attack that targets a unit within 12\", improve the Armour Penetration characteristic of that attack by 1.",""],
  ["Tactical Withdrawal","Hammer Of The Emperor","Ruse Stratégique",1,"Your Movement phase, just after a Squadron unit from your army Falls Back.","That SQUADRON unit.","Until the end of the turn, your unit is eligible to shoot in a turn in which it Fell Back.",""],
  ["Clear and Secure","Mechanised Assault","Tactique de Bataille",1,"Your Shooting phase.","One ASTRA MILITARUM unit from your army that disembarked from a Transport this turn and has not been selected to shoot this phase.","Until the end of the phase, each time a model in your unit makes an attack that targets a unit within range of an objective marker, you can re-roll the Hit roll and you can re-roll the Wound roll.",""],
  ["Hasty Extraction","Mechanised Assault","Tactique de Bataille",1,"Your opponent’s Charge phase, after an enemy unit has selected targets for its charge but before it makes a Charge move.","One Astra Militarum Infantry unit from your army that was selected as a target of that charge.","Provided your unit is not within Engagement Range of one or more enemy units and every model in your unit is within 3\" of an AsTRA Militarum Transport from your army, it can embark within that TRANSPORT.",""],
  ["Move Out","Mechanised Assault","Ruse Stratégique",1,"End of your opponent’s turn.","One ASTRA MILITARUM unit from your army.","Provided your unit is not within Engagement Range of one or more enemy units and every model in your unit is within 3\" of an Astra Militarum Transport from your army, it can embark within that TRANSPORT.",""],
  ["Rapid Dispersal","Mechanised Assault","Ruse Stratégique",1,"Your Movement phase.","One Astra Militarum Infantry unit from your army that disembarked from a Transport this phase.","Your INFANTRY unit can make a Normal move of up to D6\".",""],
  ["Swift Interception","Mechanised Assault","Tactique de Bataille",1,"Your opponent’s Movement phase, just after an enemy unit ends a Normal, Advance or Fall Back move.","One Transport unit from your army (excluding AIRCRAFT and TiTANic units) that is not within Engagement Range of one or more enemy units, and is within 8\" of the enemy unit that just ended that move.","Your TRANSPORT can make a Normal move of up to 6\".",""],
  ["Vox-Relay","Mechanised Assault","Équipement",1,"Your Command phase.","One Infantry Officer unit from your army embarked within a Transport. You can use this Stratagem on that unit even though it is embarked within a TRANSPORT.","Until the end of the phase, your unit can issue Orders even though it is not on the battlefield, and it can issue Orders to Astra Militarum Transport units from your army [excluding TiTANic units) regardless of the distance to and from your unit’s TRANSPORT.",""],
  ["Courageous Diversion","Recon Element","Ruse Stratégique",1,"Start of your opponent’s Shooting phase.","One Astra Militarum Infantry or Astra Militarum Mounted unit from your army.","Until the end of the phase, your unit has the Feel No Pain 6+ ability, and each time an enemy model makes an attack, if your unit is the closest eligible target, subtract 1 from the Hit roll.",""],
  ["Crack Shots","Recon Element","Tactique de Bataille",1,"Your Shooting phase.","One Platoon unit from your army that has not been selected to shoot this phase.","Until the end of the phase, ranged weapons equipped by models in your unit have the [PRECISION] ability.",""],
  ["Draw Them Out","Recon Element","Ruse Stratégique",1,"Your opponent’s Movement phase, just after an enemy unit ends a Normal, Advance or Fall Back move.","One Platoon unit from your army that is within 8\" of that enemy unit, and is not within Engagement Range of one or more enemy units.","Your unit can make a Normal move of up to 6\".",""],
  ["Scouting Outriders","Recon Element","Tactique de Bataille",1,"End of your opponent’s turn.","One Astra Militarum Mounted or Astra Militarum Walker unit from your army that is wholly within 10\" of one or more battlefield edges and not within Engagement Range of one or more enemy units.","Remove your unit from the battlefield and place it into Strategic Reserves.",""],
  ["Scramble Field","Recon Element","Équipement",1,"Start of your opponent’s Reinforcements step.","One Astra Militarum Infantry unit from your army.","Until the end of the phase, enemy units that are set up on the battlefield as Reinforcements cannot be set up within 12\" of your unit.",""],
  ["Tanglefoot Grenades","Recon Element","Équipement",1,"Start of your opponent’s Charge phase.","One ASTRA MILITARUM GRENADES unit from your army.","Select one visible enemy unit within 12\" of your unit. When that enemy unit declares a charge, that enemy unit has -1 to charge rolls.",""],
  ["Callous Sacrifice","Siege Regiment","Tactique de Bataille",1,"Your Shooting phase.","One Platoon unit from your army that is within Engagement Range of one or more enemy units.","Until the end of the phase, enemy units are not considered to be within Engagement Range of your unit for the purposes of selecting targets of ranged weapons. Until the end of the phase, each time an enemy model loses a wound, while that model’s unit is within Engagement Range of your unit, roll one D6: on a 4+, one model from your unit is destroyed after the attacking unit has finished making its attacks.",""],
  ["Flare Burst","Siege Regiment","Équipement",1,"Your Shooting phase.","One Astra Militarum Character unit from your army that has not been selected to shoot this phase.","Until the end of the phase, each time your unit makes an attack that targets a visible enemy unit within 12\", you can re-roll the Hit roll.",""],
  ["Furious Fusillade","Siege Regiment","Ruse Stratégique",1,"Your Shooting phase.","One Platoon unit from your army that has not been selected to shoot this phase.","Until the end of the phase, add 1 to the Attacks characteristic of ranged weapons equipped by models in your unit while targeting an enemy unit within half range.",""],
  ["Minefield","Siege Regiment","Équipement",1,"Start of your opponent’s Charge phase.","One Platoon unit from your army.","Until the end of the phase, each time an enemy unit ends a Charge move within Engagement Range of your unit, roll one D6 for each model in that enemy unit: for each 5+, that enemy unit suffers 1 mortal wound (to a maximum of 6 mortal wounds).",""],
  ["Over the Top","Siege Regiment","Ruse Stratégique",2,"Start of your Command phase.","One Infantry Officer model from your army.","Until the end of the phase, when your model issues the Move! Move! Move! Order, it can issue that Order to any number of eligible friendly Infantry Regiment units, regardless of range to your model.",""],
  ["Trench Fighters","Siege Regiment","Tactique de Bataille",1,"Fight phase, just after an enemy unit has selected its targets.","One Astra Militarum Infantry unit from your army that was selected as the target of one or more of the attacking unit’s attacks.","Until the end of the phase, each time a model in your unit is destroyed, if that model has not fought this phase, roll one D6, adding 2 to the result if it is a Regiment model. On a 4+, do not remove the destroyed model from play; it can fight after the attacking unit has finished making its attacks, and is then removed from play.",""],
  ["Accuracy Under Pressure","Steel Hammer","Tactique de Bataille",2,"Your Shooting phase.","One ASTRA MILITARUM unit from your army that has not been selected to shoot this phase.","Until the end of the phase, each time a model in your unit makes an attack, you can re-roll the Hit roll.",""],
  ["Adamantine Behemoth","Steel Hammer","Ruse Stratégique",1,"Your Movement phase or your Charge phase.","One Astra Militarum Vehicle unit from your army that has not been selected to move or charge this phase.","Until the end of the phase, each time your unit makes a Normal, Advance or Charge move, it can move horizontally through terrain features.",""],
  ["Engine of Wrath","Steel Hammer","Fait Épique",1,"Fight phase.","One Astra Militarum Titanic unit from your army that has not been selected to fight this phase.","Select one enemy unit within Engagement Range of your unit. Until the end of the phase, add 6 to the Attacks characteristic of melee weapons equipped by models in your unit, improve the Armour Penetration characteristic of those weapons by 2, and each time a model in your unit fights, it can only target that enemy unit.",""],
  ["Imposing Arrival","Steel Hammer","Ruse Stratégique",1,"Reinforcements step of your Movement phase, from the second battle round onwards.","One Astra Militarum Titanic unit from your army that is in Reserves.","Set up your unit on the battlefield, wholly within 8\" of the battlefield edge and more than 6\" horizontally away from all enemy units.",""],
  ["Shattering Salvo","Steel Hammer","Ruse Stratégique",1,"Your Shooting phase, just after an Astra Militarum Titanic unit from your army has shot.","That ASTRA MILITARUM TITANIC unit.","Select one enemy unit hit by one or more of those attacks. Until the end of the phase, that enemy unit cannot have the Benefit of Cover.",""],
  ["Withering Firepower","Steel Hammer","Ruse Stratégique",1,"Your Shooting phase, just after an Astra Militarum Vehicle unit from your army has shot.","That ASTRA MILITARUM VEHICLE unit.","Select one enemy unit hit by one or more of those attacks. That enemy unit must take a Battle-shock test, subtracting 1 from that test.",""],
